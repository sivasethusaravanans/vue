<template>
  <v-card class="mx-auto overflow-hidden" height="100%" width="100%">
    ...
    <v-app-bar color="white" light class="appbar">
    ...
    >
      <div class="d-flex">
        <img
          src="https://media.licdn.com/dms/image/C4D0BAQFxtsaLVTpecg/company-logo_200_200/0/1656928687020/wowtalkies_logo?e=2147483647&v=beta&t=8GryXH0CMc9P778MEVYStxvIOLdLo24YYj0aCuMe48A"
          alt="wowTalkies Logo"
          style="width: 60px"
        />
        <h1 class="how">wowTalkies</h1>
      </div>
      <v-list>
        ...
        <v-list-group :value="true">
          ...
          <v-list-item v-for="([title, icon], i) in Attentance" :key="i" link>
            <v-list-item-title v-text="title"></v-list-item-title>
        ...
        <v-list-group :value="true">
          ...
          <v-list-item v-for="([title, icon], i) in Teams" :key="i" link>
            <v-list-item-title v-text="title"></v-list-item-title>
        ...
        <v-list-group :value="true">
          ...
          <v-list-item v-for="([title, icon], i) in Reports2" :key="i" link>
            <v-list-item-title v-text="title"></v-list-item-title>
          ...
          <v-list-group :value="true">
            ...
            <v-list-item v-for="([title, icon], i) in BusinessSetup" :key="i" link>
              <v-list-item-title v-text="title"></v-list-item-title>
            ...
            <v-list-group :value="true">
              ...
              <v-list-item v-for="([title, icon], i) in MaintenenceSetup" :key="i" link>
                <v-list-item-title v-text="title"></v-list-item-title>
              ...
              <v-list-group :value="true">
                ...
                <v-list-item v-for="([title, icon], i) in People" :key="i" link>
                  <v-list-item-title v-text="title"></v-list-item-title>
                ...
                <v-list-group :value="true">
                  ...
                  <v-list-item v-for="([title, icon], i) in Inventory" :key="i" link>
                    <v-list-item-title v-text="title"></v-list-item-title>
                  ...
                  <v-list-group :value="true">
                    ...
                    <v-list-item v-for="([title, icon], i) in Tickets" :key="i" link>
                      <v-list-item-title v-text="title"></v-list-item-title>
                    ...
                    <v-list-group :value="true">
                      ...
                      <v-list-item v-for="([title, icon], i) in Reports" :key="i" link>
                        <v-list-item-title v-text="title"></v-list-item-title>
                      ...
                      <v-list-group :value="true">
                        ...
                        <v-list-item v-for="([title, icon], i) in SLA" :key="i" link>
                          <v-list-item-title v-text="title"></v-list-item-title>
    ...
    <v-card-text>
      The navigation drawer will appear from the left on smaller size screens.
    </v-card-text>
  </v-card>
</template>
...
.mx-auto.overflow-hidden {
  ...
  color: black; /* Change text color to white or another contrasting color */
}
.v-toolbar-title {
  color: black;
}
